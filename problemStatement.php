...
<html lang="en-US">
    ...
    <head>
        ...
        <?php 
            ...
            $data = file_get_contents('json/problemStatement.json');
            $timmer = json_decode($data);
            ...
            <ul class="scene unselectable" data-friction-x="0.1" data-friction-y="0.1" data-scalar-x="25" data-scalar-y="15" id="scene">
                ...
                <li class="layer" data-depth="0.20">
                    <div class="contact">
                        ...
                        ACM <a href="https://themewagon.com/" target="_blank">
                            <?php echo $timmer->footer; ?>
                        </a>
                        <a class="mail" href="mailto:<?php echo $timmer->email; ?>?subject=Hi%20ThemeWagon!"><?php echo $timmer->email; ?></a>
                    </div>
                </li>
            </ul>
        </div>
